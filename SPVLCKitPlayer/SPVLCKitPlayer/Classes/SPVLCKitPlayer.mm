...
@interface SPVLCKitPlayer () {
    CGRect _originFrame;
}
@property (nonatomic,strong) VLCMediaPlayer *player;
@property (nonatomic, nonnull,strong) SPVideoControlView *controlView;
@end

@implementation SPVLCKitPlayer
...
- (SPVideoControlView *)controlView {
    if (!_controlView) {
        _controlView = [[SPVideoControlView alloc] initWithFrame:self.bounds];
